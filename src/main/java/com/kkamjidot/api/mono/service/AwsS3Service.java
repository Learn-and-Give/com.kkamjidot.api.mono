...
public class AwsS3Service {
    ...
    public FileDto upload(MultipartFile multipartFile, String filePath) {
        ...
        try(InputStream inputStream = multipartFile.getInputStream()) {
            amazonS3Client.putObject(new PutObjectRequest(S3Bucket, filePath + "/" + fileName, inputStream, objectMetaData)
        ...
        return FileDto.builder()
                ...
                .path(amazonS3Client.getUrl(S3Bucket, filePath + "/" + fileName).toString()) // 접근가능한 URL 가져오기
                .build();
    }
